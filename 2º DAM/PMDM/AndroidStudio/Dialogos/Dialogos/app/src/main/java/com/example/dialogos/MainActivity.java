...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, DialogoOpcion.OnResultInterface,
        DialogoItem.OnItemInterface, DialogoSingle.OnSingleInterface, DialogoMultiple.OnMultipleInterface, DialogoXML.OnUsuarioInterface,
        DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {

    Button boton, boton2, boton3, boton4, boton5, boton6, boton7, boton8, boton9;
    TextView opciones, opciones3, opciones4, opciones5, opciones6, opciones7, opciones8, opciones9;
    ...
    private void instancias() {
        ...
        boton9 = this.findViewById(R.id.botonDialogo9);
        ...
        opciones9 = this.findViewById(R.id.opciones9);
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        opciones8.setText(dayOfMonth + " " + month + 1 + " " + year);
    }

    @Override
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        opciones9.setText(hourOfDay + " : " + minute);
    }
}
